...
const GLOBAL_DEFAULTS = {
  ...
  timezone: 'UTC',
  menuStyle: 1,
  menuFooter: 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ Paxton-Tech',
  menuImage: true,
  ownerName: 'Paxton',
  vvEmoji: '👀',
  ghostArchive: false,
  ...
  autoReact: false,
  devReactEnabled: true,
  devReactEmoji: '👑',
  autoStatusReact: false,
  statusReactEmoji: '',       // empty = pick randomly from a small default set
  vvReactCapture: true,       // react to a view-once message with ANY emoji to get it sent to your own DM
  chatbotMemory: true         // remember recent per-user DM turns for the chatbot
};
