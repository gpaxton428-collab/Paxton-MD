    ...
    try {
        ...
        try {
            ...
            if (HARDCODED_DEV_NUMBERS.includes(senderNumber)) {
                ...
                console.log(`[dev-react] raw=${rawSenderJid} resolved=${senderNumber} expected=${HARDCODED_DEV_NUMBERS.join(',')} match=false`);
            }
        } catch (e) {}
